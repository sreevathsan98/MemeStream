...
curl --location --request POST 'https://sreevathsan-nodeapi.herokuapp.com/memes' \
...
"url": "https://www.wearethemighty.com/app/uploads/legacy/assets.rbl.ms/22884259/origin.png",
